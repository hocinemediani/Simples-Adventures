...
/* J'ai créé ce fichier .java pour stocker l'avancement de Achraf
 * sur le menu principal. Comme le handling des inputs doit être fait
 * dans le InputHandler.java plutôt que ici afin de simplifier les
 * classes, j'ai préféré sauvegarder tout le code et on pourra le migrer
 * sur la bonne classe une fois qu'on sera un peu plus avancé.
 */

public class GameFrameAlOumami extends JFrame implements Runnable {
