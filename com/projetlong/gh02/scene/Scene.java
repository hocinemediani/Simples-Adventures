    ...
    public Scene(String backgroundTilePath, String obstacleTilePath, String decorationTilePath, File mapFile, File tileFile, GameFrame game, int sceneID) {
        ...
        switch (sceneID) {
            ...
            default -> {
                ...
                this.npc1 = new NPC(this.playerTileSheet, -49, -1434, "It's time for you to go on an adventure !", "Albert mais plus loin");
                this.npc2 = new NPC(this.playerTileSheet, 600, 400, "You know how to walk ? Magnifique !", "Albert");
